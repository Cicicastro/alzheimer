...
def generate_graphs(df, dataset_name):
    ...
    fig_educ = px.histogram(df, x="EDUC", color="Condition", title=f"{title_prefix} - Education Level Distribution", color_discrete_map=custom_palette)
    ...
    # Gráfico de barras para distribuição percentual de Alzheimer por gênero
    ...
    p_value_card = html.Div(
        style={"border": "2px solid black", "padding": "10px", "margin-top": "20px", "width": "50%"},
        children=[
